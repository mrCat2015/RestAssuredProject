...
public class RestAssuredMethodChaining {
    ...
    @Test
    public void chainingMethodTest1() {
        ...
        when().
                get("http://100.25.36.30:8000/api/hello").   // sending a request to this url
    ...
    @Test
    public void testingWithMatching(){
        when().
                get("http://100.25.36.30:8000/api/hello").   // sending a request to this url
                prettyPeek().
        then(). // asssrtions start here
...
@Test
    ...
    // then part -- ValidatableResponse
        ...
        when().
                get("http://100.25.36.30:8000/api/spartans").
                prettyPeek().
        then().statusCode(200);
}
}
